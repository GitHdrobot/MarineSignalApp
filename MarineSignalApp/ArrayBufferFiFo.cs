...
*/
    ...
    public class ArrayBufferFiFo<T>
    {
        /// <summary>
        /// 默认大小.
        /// </summary>
        private const int DFLT_SIZE = 1024 * 1024;
        /// <summary>
        /// 缓冲区还能容纳的元素数目.
        /// </summary>
        private int space = 0;
        ...
        public ArrayBufferFiFo(int capacity)
            : this(new T[capacity])
            {
        }
        /// <summary>
        ...
        public ArrayBufferFiFo(T[] buf, int offset, int size)
        {
            this.dataBuf = buf;
            capacity = buf.Length;
            available = size;
