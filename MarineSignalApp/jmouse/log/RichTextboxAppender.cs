...
namespace log4net.Appender
{
    ...
    /// </code>
    /// <para>
    /// The Level is the standard log4net logging level. TextColorName and BackColorName shoul match 
...
/// <code>true</code> or <code>false</code>. FontFamilyName should match a font available on the client,
    ...
    public class RichTextBoxAppender : AppenderSkeleton
    {
        ...
        /// <returns>True if a RichTextBoxAppender named <code>appenderName</code>
        /// <return>was found</returns>
        /// <remarks>
